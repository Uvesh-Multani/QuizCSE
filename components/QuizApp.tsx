...
//         >
//           <h1 className="text-3xl font-bold text-center mb-6">CS QuizMaster</h1>
//           <Input
//             type="text"
...
//   if (showResult) {
//     return <QuizResult userName={userName} score={score} totalQuestions={shuffledQuestions.length} />
//   }
